...
def get_openai_client():
    # Modified by Codex Factory: construct this network client lazily so importing
    # local-only routers does not require credentials or initialize network state.
